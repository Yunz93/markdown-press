  ...
  return (
    <div className="select-none" data-file-tree-item>
      <div
        ref={itemRef}
        className={`
          group flex items-center py-2 px-3 cursor-pointer transition-all duration-200 mx-2 rounded-lg text-sm border border-transparent
          ${
            isActive
              ? "bg-accent-DEFAULT/12 text-gray-900 font-semibold shadow-sm ring-1 ring-inset ring-accent-DEFAULT/30 dark:bg-accent-DEFAULT/18 dark:text-white dark:ring-accent-DEFAULT/35"
