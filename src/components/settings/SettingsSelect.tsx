...
/**
 * Settings dropdown that matches input height and opens as a natural
 * attached list (not a centered OS popup menu).
 */
            ...
            {options.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`settings-select-option ${isActive ? "is-active" : ""}`}
                  onClick={() => {
