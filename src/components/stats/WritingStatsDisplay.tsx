...
export const WritingStatsDisplay: React.FC<WritingStatsDisplayProps> = ({
  ...
  return (
    <div className={`writing-stats flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 px-4 py-2 ${showBorder ? 'border-t border-gray-200/50 dark:border-white/5' : ''} ${className}`}>
