      ...
      >
        ...
        >
          <button
            ...
            title={
              isSidebarOpen
                ? t("toolbar_hideSidebar")
                : t("toolbar_showSidebar")
            }
            aria-label={
              isSidebarOpen
                ? t("toolbar_hideSidebar")
          ...
          >
            ...
            >
              ...
              <line
                x1={isSidebarOpen ? 9 : 6}
                y1="4"
                x2={isSidebarOpen ? 9 : 6}
                y2="20"
              />
            </svg>
          </button>
        ...
        >
          <button
            ...
            title={
              isDark ? t("toolbar_switchToLight") : t("toolbar_switchToDark")
            }
          >
            {isDark ? (
              <svg
