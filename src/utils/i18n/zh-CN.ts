export default {
  ...
  app_openingDocument: "正在打开文档",
  app_openingDocumentDesc: "正在打开所选文件。",
  app_openingDocumentStatus: "正在打开文件...",
  ...
  askVault_history: "历史",
  askVault_historyEmpty: "还没有问答记录。",
  askVault_historyCitations: "{count} 条引用",
  ...
  context_openInNewWindow: "在新窗口打开",
  context_delete: "删除",
  ...
  settings_toggleViewDesc: "在源码、分屏与阅读之间循环切换。",
  ...
  settings_newWindow: "新建窗口",
  settings_newWindowDesc: "打开一个新的应用窗口（桌面端）。",
  ...
  notifications_newWindowDesktopOnly: "新建窗口仅在桌面应用中可用",
  notifications_openNewWindowFailed: "无法打开新窗口：{{error}}",
