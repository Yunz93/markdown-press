export default {
  ...
  index_embeddingDesc:
    "配置 OpenAI 兼容的 /embeddings 接口（如 Ollama）后，侧边栏可用语义/混合搜索，右侧「相关」更准。未配置时自动降级为关键词。",
  ...
  index_privacyMode: "隐私模式（仅允许本地 embedding 端点）",
  index_privacyModeDesc:
    "开启后，embedding 仅允许 localhost / 127.0.0.1，避免文本片段上传到公网。",
