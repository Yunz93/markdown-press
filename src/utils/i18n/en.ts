export default {
  ...
  index_embeddingDesc:
    "Configure an OpenAI-compatible /embeddings endpoint (e.g. Ollama) to enable semantic/hybrid sidebar search and better related notes. Falls back to keyword search when unset.",
  ...
  index_privacyMode: "Privacy mode (local embedding endpoints only)",
  index_privacyModeDesc:
    "When enabled, embeddings may only use localhost / 127.0.0.1 so note chunks are not sent to the public internet.",
