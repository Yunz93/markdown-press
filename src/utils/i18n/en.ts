export default {
  ...
  askVault_historyEmpty: "No past questions yet.",
  askVault_historyCitations: "{count} citations",
  ...
  settings_toggleViewDesc: "Cycle between Source, Live preview, and Reading.",
