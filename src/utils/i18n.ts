...
const translations = {
  'zh-CN': {
    ...
    settings_chineseFontDesc: '默认为内置的霞鹜文楷字体，与应用一起打包，确保中文渲染效果一致。',
  ...
  en: {
    ...
    settings_chineseFontDesc: 'Defaults to the bundled LXGW WenKai font to keep Chinese rendering consistent.',
