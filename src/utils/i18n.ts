...
const translations = {
  'zh-CN': {
    ...
    settings_shortcutsIntro: '快捷键按使用场景分组。可编辑项可以直接修改，内置快捷键仅作参考。',
    settings_shortcutsEditable: '可修改',
  ...
  en: {
    ...
    settings_shortcutsIntro: 'Shortcuts are grouped by workflow. Editable shortcuts can be changed here; built-in shortcuts are shown for reference.',
    settings_shortcutsEditable: 'Editable',
