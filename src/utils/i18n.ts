...
const translations = {
  'zh-CN': {
    ...
    share_longImageDesc: '按当前预览样式生成整张纵向 PNG，可滚动预览后保存、复制或使用系统分享。',
    share_generate: '生成长图',
    ...
    wechatDraftDialog_updateHint: '检测到当前笔记已经关联公众号草稿，这次会直接更新原草稿。',
    ...
    wechatDraftDialog_coverDesc: '封面图会上传为公众号缩略图素材。正文里的本地图片会自动转换为公众号可用图片。',
    ...
    settings_markdownStyleDesc: '控制编辑区、预览区和导出文档的 Markdown 阅读样式；每种样式都同时支持浅色和深色主题。',
    settings_exportStrikethroughMode: '导出删除线（长图 / PDF / HTML）',
    settings_exportStrikethroughModeDesc: '「与预览一致」使用浏览器原生 line-through，与预览一致；html2canvas 栅格化在少数环境下可能对删除线支持不完美。「栅格兼容」用背景线模拟，更稳，但删除线纵向位置可能与预览不同。',
    settings_exportStrikethroughPreviewNative: '与预览一致（原生删除线）',
    settings_exportStrikethroughRasterSafe: '栅格兼容（背景线）',
    settings_englishFont: '英文字体',
    settings_englishFontDefaultOption: '默认英文字体（系统字体）',
    settings_englishFontBundledOption: '内置英文字体（Tsanger JinKai 02）',
    ...
    settings_chineseFontDefaultOption: '默认中文字体（Tsanger JinKai 02）',
    settings_chineseFontBundledOption: '内置中文字体（Tsanger JinKai 02）',
    settings_chineseFontDesc: '默认使用内置的 Tsanger JinKai 02，未命中时再回退到系统中文字体。',
    ...
    settings_aboutMessageValue: '这是我理想中 Markdown 编辑器的样子，希望你也会喜欢，欢迎反馈问题和意见。',
    ...
    settings_wechatSectionDesc: '把当前笔记发布到微信公众号草稿箱，支持后续更新已有草稿。',
    settings_wechatAppId: '公众号 AppID',
    settings_wechatAppIdPlaceholder: '例如：wx1234567890abcdef',
    settings_wechatAppIdDesc: '填写公众号的开发者 AppID。它会随设置一起保存在本地。',
    settings_wechatAppSecret: '公众号 AppSecret',
    settings_wechatAppSecretPlaceholder: '在此粘贴 AppSecret...',
    settings_wechatAppSecretDesc: '必填。用于获取公众号 access_token，仅保存在当前设备的安全存储中。',
    settings_wechatAppSecretHint: '请先在微信公众平台开发设置中开启开发者能力，并确认服务器出口 IP 已加入白名单。',
    settings_wechatGuide1: '发布到草稿箱会先把正文中的本地图片上传为公众号可用图片，再创建或更新草稿。',
    settings_wechatGuide2: '第一版只支持单个公众号账号。再次发布同一篇笔记时，会优先使用笔记里保存的 `wechat_draft_media_id` 更新原草稿。',
    settings_wechatGuide3: '封面图会在发布时临时选择，并上传为公众号缩略图素材。',
    settings_desktopPublishOnly: '一键发布仅在桌面版可用。',
    settings_updatesSectionTitle: '应用更新',
    settings_updatesSectionDesc: 'Windows 版支持应用内检查和安装更新；macOS 当前仍通过 GitHub Releases 手动下载。',
    settings_updatesDesktopOnly: '应用更新仅在桌面版可用。',
    settings_updatesMacManualDesc: 'macOS 当前不提供应用内安装更新。请前往 GitHub Releases 下载新版本，然后按现有方式安装。',
    ...
    settings_updatesAutoCheckDesc: '仅在 Windows 桌面版启用。发现新版本后会给出提示，但不会立刻打断当前写作。',
    ...
    settings_updatesGuide1: 'Windows 应用内更新依赖 GitHub Release 中的 `latest.json` 和签名更新包；发布新版本后，已安装用户才能收到更新。',
    settings_updatesGuide2: '如果刚发布了新版本但客户端还没检测到，先确认该 release 已包含 updater 产物，再重新检查一次。',
    ...
    notifications_setWechatAppSecretFirst: '请先在发布设置里填写公众号 AppSecret。',
    ...
    notifications_updateAvailable: '发现新版本 {version}，可前往设置中的“关于”安装。',
    ...
    notifications_wechatDraftSuccess: '已发布到微信公众号草稿箱，并更新了笔记草稿标识。',
    notifications_wechatDraftBackfillFailed: '已发布到微信公众号草稿箱，但写回草稿标识失败。',
  ...
  en: {
    ...
    share_longImageDesc: 'Render the current preview as one tall PNG. Scroll to inspect, then save, copy, or use the system share sheet.',
    ...
    publish_targetDesc: 'This entry can publish to the blog or the WeChat Official Account draft box.',
    publish_targetSimpleBlog: 'Simple Blog',
    publish_targetSimpleBlogDesc: 'Sync to the blog repository and trigger deployment.',
    publish_targetWechatDraft: 'WeChat draft',
    publish_targetWechatDraftDesc: 'Create or update a single-article draft in the Official Account draft box.',

    wechatDraftDialog_title: 'Publish to WeChat drafts',
    wechatDraftDialog_desc: 'Review the article metadata and pick a cover image before publishing.',
    wechatDraftDialog_updateHint: 'This note is already linked to a WeChat draft, so publishing will update that draft.',
    ...
    wechatDraftDialog_coverDesc: 'The cover image is uploaded as a WeChat thumbnail asset. Local body images are converted into WeChat-hosted article images automatically.',
    ...
    settings_markdownStyleTypewriter: 'Typewriter Inspired',
    settings_markdownStylePrimary: 'Primary Inspired',
    settings_markdownStyleDesc: 'Controls Markdown reading styles for the editor, preview, and exported document. Each style supports both light and dark themes.',
    settings_exportStrikethroughMode: 'Exported strikethrough (long image / PDF / HTML)',
    settings_exportStrikethroughModeDesc: '“Match preview” uses native line-through like the preview pane; html2canvas may occasionally omit or misplace it. “Raster-safe” draws a background stripe for more reliable PNG/PDF capture, but vertical alignment can differ from preview.',
    settings_exportStrikethroughPreviewNative: 'Match preview (native line-through)',
    settings_exportStrikethroughRasterSafe: 'Raster-safe (background line)',
    settings_englishFont: 'English font',
    settings_englishFontDefaultOption: 'Default English font (system)',
    settings_englishFontBundledOption: 'Bundled English font (Tsanger JinKai 02)',
    settings_englishFontDesc: 'Used for Latin letters, numbers, and symbols.',
    settings_englishFontPreview: 'English font preview: Markdown Press toolbar and sidebar',
    settings_chineseFont: 'Chinese font',
    settings_chineseFontDefaultOption: 'Default Chinese font (Tsanger JinKai 02)',
    settings_chineseFontBundledOption: 'Bundled Chinese font (Tsanger JinKai 02)',
    settings_chineseFontDesc: 'Defaults to the bundled Tsanger JinKai 02 and falls back to the system Chinese font when unavailable.',
    ...
    settings_aboutDesc: 'See the current version, check for updates, and review how updates work on each platform.',
    settings_aboutAuthor: 'Author',
    settings_aboutAuthorValue: 'Yunz93',
    settings_aboutMessage: 'Message',
    settings_aboutMessageValue: 'This is what the ideal Markdown editor looks like to me. I hope you like it too, and feedback is always welcome.',
    settings_simpleBlogSectionTitle: 'Simple Blog',
    ...
    settings_wechatSectionDesc: 'Publish the current note to the WeChat Official Account draft box and update the same draft later.',
    settings_wechatAppId: 'WeChat AppID',
    settings_wechatAppIdPlaceholder: 'Example: wx1234567890abcdef',
    settings_wechatAppIdDesc: 'Enter the Official Account AppID. It is stored with the normal local settings.',
    settings_wechatAppSecret: 'WeChat AppSecret',
    settings_wechatAppSecretPlaceholder: 'Paste the AppSecret here...',
    settings_wechatAppSecretDesc: 'Required. Used to obtain the Official Account access token and stored only in secure local storage.',
    settings_wechatAppSecretHint: 'Enable developer access in WeChat Official Account settings and make sure your outbound server IP is in the allowlist.',
    settings_wechatGuide1: 'Publishing to drafts uploads local body images as WeChat article images before creating or updating the draft.',
    settings_wechatGuide2: 'The first version supports one Official Account only. Republishing the same note prefers the saved `wechat_draft_media_id` and updates that draft.',
    settings_wechatGuide3: 'The cover image is selected during publishing and uploaded as a WeChat thumbnail asset.',
    ...
    settings_updatesSectionDesc: 'Windows supports in-app update checks and installation. macOS remains a manual download flow from GitHub Releases for now.',
    settings_updatesDesktopOnly: 'App updates are available in the desktop app only.',
    settings_updatesMacManualDesc: 'macOS does not support in-app installation updates in this phase. Download the new build from GitHub Releases and install it manually.',
    ...
    settings_updatesAutoCheckDesc: 'Enabled only for the Windows desktop build. New versions show a reminder without interrupting your current work.',
    ...
    settings_updatesGuide1: 'Windows in-app updates depend on the `latest.json` metadata file and signed updater artifacts uploaded to the GitHub Release.',
    settings_updatesGuide2: 'If you just published a release and the client still does not see it, verify the release contains the updater assets first, then check again.',
    ...
    notifications_longImageShareUnsupported: 'This environment cannot hand off the image to the system share sheet',
    ...
    notifications_setWechatAppIdFirst: 'Set the WeChat AppID in Publishing settings first.',
    notifications_setWechatAppSecretFirst: 'Set the WeChat AppSecret in Publishing settings first.',
    notifications_setWechatCoverFirst: 'Choose a cover image for the WeChat draft first.',
    ...
    notifications_updateAvailable: 'Update {version} is available. Open Settings → About to install it.',
    ...
    notifications_wechatDraftSuccess: 'Published to the WeChat draft box and updated the note draft marker.',
    notifications_wechatDraftBackfillFailed: 'Published to the WeChat draft box, but failed to write the draft marker back into the note.',
