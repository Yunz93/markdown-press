...
const translations = {
  'zh-CN': {
    ...
    settings_uiFontDesc: '只影响应用界面。默认使用系统字体，也可切换到内置或其他系统字体。',
  ...
  en: {
    ...
    settings_uiFontDesc: 'Applies only to the app UI. The default uses the system font, and you can switch to the bundled font or another system font.',
    ...
    settings_chineseFontDesc: 'Defaults to the system Chinese font, with the bundled Tsanger JinKai available as an option.',
