...
const translations = {
  'zh-CN': {
    ...
    settings_previewFontDesc: '控制预览区正文排版与导出 HTML 的正文字体。',
    settings_previewFontPreview: '预览区字体预览：渲染后的 Markdown 正文',
    settings_codeFont: '代码字体',
    settings_codeFontDesc: '控制编辑区代码块、预览区代码块以及导出 HTML 的代码字体。',
    ...
    settings_exportHtml: '导出 HTML',
    settings_exportHtmlDesc: '把当前预览导出为独立的 HTML 文件。',
  ...
  en: {
    ...
    settings_previewFontDesc: 'Controls preview typography and exported HTML body text.',
    settings_previewFontPreview: 'Preview font preview: rendered Markdown content',
    settings_codeFont: 'Code font',
    settings_codeFontDesc: 'Controls code blocks in the editor, preview, and exported HTML.',
    settings_codeFontPreview: 'const note = "Markdown Press";',
    ...
    settings_exportHtml: 'Export HTML',
    settings_exportHtmlDesc: 'Export the current preview as a standalone HTML file.',
