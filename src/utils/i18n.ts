...
const translations = {
  'zh-CN': {
    ...
    settings_uiFontDesc: '只影响应用界面，不影响编辑器和预览正文。字体候选优先读取系统字体，默认字体为 TsangerJinKai02-W04。',
    settings_uiFontBundledOption: '默认字体（TsangerJinKai02-W04）',
    ...
    settings_englishFontDefaultOption: '默认英文字体（TsangerJinKai02-W04）',
    ...
    settings_chineseFontBundledOption: '默认中文字体（TsangerJinKai02-W04）',
    settings_chineseFontDesc: '默认使用 TsangerJinKai02-W04，未安装时回退到系统中文字体。',
  ...
  en: {
    ...
    settings_uiFontDesc: 'Applies only to the app UI, not the editor or preview content. System fonts are listed directly, with TsangerJinKai02-W04 used as the default font.',
    settings_uiFontBundledOption: 'Default font (TsangerJinKai02-W04)',
    ...
    settings_englishFontDefaultOption: 'Default English font (TsangerJinKai02-W04)',
    settings_englishFontDesc: 'Used mainly for Latin letters, numbers, and symbols.',
    settings_englishFontPreview: 'English font preview: Markdown Press toolbar and sidebar',
    settings_chineseFont: 'Chinese font',
    settings_chineseFontBundledOption: 'Default Chinese font (TsangerJinKai02-W04)',
    settings_chineseFontDesc: 'Defaults to TsangerJinKai02-W04, then falls back to system Chinese fonts when unavailable.',
